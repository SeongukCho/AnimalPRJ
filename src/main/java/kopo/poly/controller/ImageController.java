...
public class ImageController {
    ...
    public ResponseEntity<?> profileChange(HttpServletRequest request,
        ...
        userInfoService.getNickNameExists(pDTO);
...
//                userInfoService.profilePathProc(iDTO);
    ...
    public ResponseEntity<?> uploadNoticeImage(@RequestParam("file") MultipartFile file, @RequestParam("boardSeq") Long boardSeq, HttpSession session) {
